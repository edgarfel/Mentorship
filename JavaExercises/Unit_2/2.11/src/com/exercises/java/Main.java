...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BigInteger years= input.nextBigInteger();
        ...
        BigInteger finalYears = totalPerYear.multiply(years);
        ...
        System.out.println("The population in "+years+" years will be: "+finalYears);
    }
}
